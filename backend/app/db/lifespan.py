...
async def seed_initial_data(session: AsyncSession):
    ...
    try:
        # 指定的發射器設備列表
        tx_list = [
            ("tx0", -110, -100, -5, 2.61799387799, 0, 0, "desired", 30),
            ("tx1", -106, 56, 16, 0.52359877559, 0, 0, "desired", 30),
            ("tx2", 100, -100, -5, -1.57079632679, 0, 0, "desired", 30),
            ("jam1", 100, 50, -5, 1.57079632679, 0, 0, "jammer", 40),
            ("jam2", 41, 50, 19, 1.57079632679, 0, 0, "jammer", 40),
            ("jam3", -50, -50, -5, 1.57079632679, 0, 0, "jammer", 40),
        ]
