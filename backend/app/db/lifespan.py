...
async def seed_initial_data(session: AsyncSession):
    ...
    try:
        # 指定的發射器設備列表
        tx_list = [
            ("tx0", -100, -100, 20, 2.61799387799, 0, 0, "desired", 30),
            ("tx1", -100, 50, 20, 0.52359877559, 0, 0, "desired", 30),
            ("tx2", 100, -100, 20, -1.57079632679, 0, 0, "desired", 30),
            ("jam1", 100, 50, 20, 1.57079632679, 0, 0, "jammer", 40),
            ("jam2", 50, 50, 20, 1.57079632679, 0, 0, "jammer", 40),
            ("jam3", -50, -50, 20, 1.57079632679, 0, 0, "jammer", 40),
        ]

        # 指定的接收器設備
        rx_config = ("rx", [0, 0, 20], [0, 0, 0], "receiver", 0)
